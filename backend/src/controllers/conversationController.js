...
export const createConversation = async (req, res) => {
  try {
    ...
    if (type === "direct") {
      ...
      // Reuse existing direct conversation if one already exists
...
// Returns all conversations the current user is part of, sorted by most recent
...
// Returns messages for a conversation in batches, oldest to newest
...
// Used by socket.io on connect to join all relevant conversation rooms
...
// Marks the last message as seen and resets the user's unread count
